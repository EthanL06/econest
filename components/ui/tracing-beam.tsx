      ...
      <div className="absolute -left-20 top-3">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#90EE90" stopOpacity="0"></stop>
              <stop stopColor="#90EE90"></stop>
              <stop offset="0.325" stopColor="#006400"></stop>
              <stop offset="1" stopColor="#006400" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
