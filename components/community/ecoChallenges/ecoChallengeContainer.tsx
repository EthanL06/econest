...
const EcoChallengesContainer = (props: Props) => {
  ...
  return (
    <div className="flex h-full w-full flex-col ">
      <h1 className="text-4xl font-bold text-left my-8">Eco Challenges</h1>
      <div className="flex flex-wrap justify-center ">
        {challenges.map((challenge) => (
          <div
            key={challenge.id}
            className="w-full p-4 sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/4 cursor-pointer"
          >
      ...
      <div className="w-screen ml-[-28px]">
      <TopWave2 />
      <div className="flex flex-wrap justify-center my-[-3px] bg-[#5FA25E] pr-3">
          { friends.map((user) => (
            <div
            key={user.id}
      ...
      <h1 className="text-4xl font-bold text-left my-8">Discover Solutions</h1>
      <div className="flex flex-wrap justify-center ">
        {blogs.map((blog) => (
          <div
            key={blog.href}
            className="w-full p-4 sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/5 cursor-pointer "
          >
