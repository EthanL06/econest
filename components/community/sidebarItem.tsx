...
const SidebarItem: React.FC<SidebarItemProps> = ({ user, chat }) => {
    ...
    return (
        <div className="flex items-center p-4 hover:bg-gray-100 rounded-lg shadow-md transition-colors duration-200 overflow-hidden">
