...
const DiscussionItem: React.FC<DiscussionItemProps> = ({
  ...
  const handleClick = () => {
    router.push(`/forum/${discussion.forumId}`);
  ...
  return (
    <div
      className="flex cursor-pointer flex-col items-center border-b border-gray-200 p-4 hover:bg-gray-100 md:flex-row"
      onClick={handleClick}
    >
      <div className="mb-4 w-full flex-shrink-0 sm:w-auto md:mb-0 md:mr-4">
        <Image
          ...
          className="aspect-video w-full rounded-lg sm:size-20"
        />
      </div>
      ...
      <div className="mt-4 w-full flex-wrap gap-2 sm:w-auto md:mt-0">
        ...
        <div className="flex items-center gap-1 text-xs">
          ...
          •
          <p className="text-gray-500">
            {convertTimeToEnglish(discussion.forumDate)}
          </p>
        </div>
      </div>
    </div>
