...
const LeaderboardSidebarItem: React.FC<LeaderboardSidebarItemProps> = ({
  ...
  return (
    <>
      <li
        className="relative mt-2 flex cursor-pointer items-center justify-between border-b border-gray-200 p-2 hover:bg-gray-100"
      ...
      >
        ...
        <Image
          ...
          width={500}
          height={500}
          className="mr-4 aspect-square h-10 w-10 rounded-full object-cover"
          placeholder="blur"
