...
const CallToAction = (props: Props) => {
  return (
    <div className="relative flex w-full flex-col items-center justify-center rounded-xl px-4 py-8  shadow-2xl md:p-12 lg:p-24">
      <img
        src="https://wallpapers.com/images/hd/environment-background-c2ut7fq0hpz6my6c.jpg"
        alt="background"
        className="absolute inset-0 -z-10 h-full w-full rounded-xl object-cover brightness-[30%]"
      />
