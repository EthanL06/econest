...
export default function RootLayout({
  ...
  return (
    <div
      className={`${quicksand.variable} max-w-screen-[1400px] relative mx-auto overflow-x-hidden px-8 py-2 font-sans text-black sm:px-8 sm:py-4`}
    >
      <div>
        <Link className="" href="/">
          <div className="group flex items-center gap-x-2">
            <svg
              ...
              className={
                "size-10 rotate-0 transform transition-all duration-300 group-hover:rotate-3"
              }
              viewBox="0 0 512 512"
            >
              <path
            ...
            <div
              className={
                "w-24 overflow-hidden text-2xl font-semibold transition-all duration-300"
              }
            >
